# Generated by Django 5.0 on 2025-07-22 10:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to=Sims.models.document_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allocated_type', models.CharField(choices=[('Laptop', 'Laptop'), ('Mouse', 'Mouse'), ('Charger', 'Charger'), ('Headphone', 'Headphone')], max_length=50, null=True)),
        ...
        migrations.AddField(
            model_name='document',
            name='receiver',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='received_documents', to='Sims.temp'),
        ),
        migrations.AddField(
            model_name='document',
            name='uploader',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_documents', to='Sims.temp'),
        ),
        migrations.CreateModel(
            name='CollegeDetails',
            fields=[
                ...
                ('college_email_id', models.EmailField(blank=True, max_length=254, null=True)),
                ('college_name', models.CharField(max_length=255)),
                ('degree', models.CharField(max_length=100)),
                ('college_department', models.CharField(max_length=100)),
                ('degree_type', models.CharField(choices=[('UG', 'Undergraduate'), ('PG', 'Postgraduate'), ('Others', 'Others')], max_length=100, null=True)),
                ('year_of_passing', models.IntegerField(blank=True, null=True)),
                ('cgpa', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('college_faculty_phonenumber', models.IntegerField(blank=True, null=True)),
                ('created_date', models.DateField(auto_now_add=True)),
                ('updated_date', models.DateField(auto_now=True)),
                ('emp_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Sims.temp')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(blank=True, choices=[('LIVE_ON', 'Live on'), ('LIVE_OFF', 'Live off'), ('START_BREAK', 'Start Break'), ('END_BREAK', 'End Break'), ('END_LUNCH', 'End Lunch'), ('START_LUNCH', 'Start Lunch'), ('END_OF_SHIFT', 'End of Shift'), ('START_OTHERS', 'Start Others'), ('END_OTHER', 'End Other')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_status', models.CharField(choices=[('active', 'Active'), ('inprogress', 'In Progress'), ('completed', 'Completed'), ('yettojoin', 'Yet to Join'), ('holdandwait', 'Hold and Wait'), ('discontinued', 'Discontinued'), ('deleted', 'Deleted')], default='active', max_length=15)),
                ('created_date', models.DateField(auto_now_add=True)),
                ('updated_date', models.DateField(auto_now=True)),
                ...
                ('certicate_sent', models.BooleanField(blank=True, default=False, null=True)),
