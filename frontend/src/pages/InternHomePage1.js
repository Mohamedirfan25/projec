...
import exampleImage from './emp.jpeg'; // Path to your employee image
...
const FeatureCard = styled(Card)({
  ...
  marginBottom: '40px', // Added space between cards
...
const InternHomePage = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      {/* Navbar */}
      <Header position="fixed" navbarColor={navbarColor}>
        <Toolbar>
  ...
  {[
    ...
    >
      ...
      <Drawer anchor="right" open={drawerOpen} onClose={() => setDrawerOpen(false)}>
        <List>
          {["Home", "About Us", "Contact Us", "Settings"].map((text, index) => (
          ...
          {[
            {
              ...
              icon: <img src={exampleImage} alt="Feature" style={{ width: '100%', height: '200px', borderRadius: '10px', objectFit: 'cover' }} />,
            ...
            },
            {
              ...
              icon: <img src={documentImage} alt="Feature" style={{ width: '100%', height: '200px', borderRadius: '10px', objectFit: 'cover' }} />,
              desc: "Dimiour, our specialized digital solutions division, delivers innovative, scalable, efficient, customized, and cutting-edge services empower businesses to transform, grow, dynamic digital era..."
            },
          ].map((feature, index) => (
            <FeatureCard key={index}>
              <CardContent>
                <Box>{feature.icon}</Box>
                <Typography variant="h6" sx={{ marginTop: '10px' }}>{feature.title}</Typography>
                <Typography color="textSecondary" sx={{ marginTop: '10px' }}>{feature.desc}</Typography>
              </CardContent>
            </FeatureCard>
          ))}
        </GridContainer>
